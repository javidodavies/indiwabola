...
export default async function PlayersPage() {
  const data = await fetchAPI<Player>(worldCupEndpoints.players);
  ...
  return (
    <section className="py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold mb-6 text-primary-green">Players</h1>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {player.statistics[0]?.team.name} • {player.player.position}
                </p>
              </div>
            </Link>
          ))}
